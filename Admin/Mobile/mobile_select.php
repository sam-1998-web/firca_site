...
<body style="background-color:#eef5fe">
    ...
    <div class="my-5 table_div" align="center">
        ...
        <a href="./mobile.php" class="select_anchore_style">ADD DATA</a>
        ...
        <table border="5" cellspacing="5">
            ...
            ?>
                <tr>
                    ...
                    <!-- EDIT INFORMATION  -->
                    <td> <a href="./mobile_edit.php ? edit_id=<?php echo $fetch['id'] ?>">Edit</a> / <a href="./mobile_delete.php ? delete_id=<?php echo $fetch['id'] ?>">Delete</a> </td>
